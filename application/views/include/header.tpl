    ...
    <div class="top-header">
        <div class="container">
            <div class="nav-top-links">
                <a class="first-item" href="#"><img alt="phone" src="{$IMG}/phone.png" />00-62-658-658</a>
                <a href="#"><img alt="email" src="{$IMG}email.png" />Contact us today!</a>
            </div>
            <div class="currency ">
                <div class="dropdown">
            ...
            <div class="language ">
                <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="#"><img alt="email" src="{$IMG}en.jpg" />English</a></li>
                        <li><a href="#"><img alt="email" src="{$IMG}fr.jpg" />French</a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container main-header">
        <div class="row">
            <div class="col-xs-12 col-sm-3 logo">
                <a href="index.html"><img alt="Kute shop - themelock.com" src="{$IMG}logo.png" /></a>
            </div>
