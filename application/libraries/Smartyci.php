...
require_once( 'application/third_party/smarty-3.1.27/libs/Smarty.class.php' );
class Smartyci extends Smarty
{
    public function __construct()
    {
        ...
        $this->caching = 1;
        $this->setCacheLifetime(500);
        $this->setTemplateDir( APPPATH. 'views' );
        $this->setCompileDir( APPPATH . 'third_party/smarty-3.1.27/templates_c' );
